...
if [ "$1" == "" ]; then
    ...
    do 
        ...
        do
            ...
            do
                ...
                python ./src/toy_experiment.py --seed $seed --alea $alea --anomaly_value $anomaly_value --metric True
            done
        done
    done
    ...
    do
        ...
        do
            ...
            do
                for alea in 0.707 # option of alea: 0.707, 1.0, 1.414  
                do 
                    for anomaly_value in 10 # option of anomaly_value: 10, 20, 30
                    do
                        for seed in {1,2,3,4,5}
                        do
